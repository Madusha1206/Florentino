...
import { ShoppingCart, X, Truck, Home as HomeIcon } from 'lucide-react';
      ...
      {showDeliveryBanner && (
        <div className="header-banner">
          ...
          <div className="header-banner-right">
            ...
            <button onClick={() => setShowDeliveryBanner(false)} className="banner-close" aria-label="Close banner">
              <X className="banner-close-icon" />
            </button>
          </div>
        </div>
      )}
