...
const WhatsAppChat = () => {
  ...
  return (
    <button
      ...
      aria-label="Chat with Florentino on WhatsApp"
      title="Chat with us on WhatsApp"
      style={{ backgroundColor: "#25D366" }}
      className="whatsapp-chat-button fixed bottom-6 right-6 text-white h-16 w-16 flex items-center justify-center rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 z-50 group"
    >
