...
const items = [
  { code: 'FLR-FB-001', price: 4200 },
  { code: 'FLR-FB-002', price: 5000 },
  { code: 'FLR-FB-003', price: 5800 },
  { code: 'FLR-FB-004', price: 6500 },
  { code: 'FLR-FB-005', price: 4500 },
  { code: 'FLR-FB-006', price: 5200 },
  { code: 'FLR-FB-007', price: 6200 },
  { code: 'FLR-FB-008', price: 7200 },
];
  ...
  return (
    <main className="min-h-screen bg-gray-50 py-10">
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900">Flower Bunches</h1>
          <p className="mt-3 text-gray-600">Beautiful flower bunches for any celebration.</p>
        </div>
