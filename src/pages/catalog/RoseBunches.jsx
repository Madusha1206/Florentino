...
const items = [
  { code: 'FLR-RB-001', price: 3500 },
  { code: 'FLR-RB-002', price: 4200 },
  { code: 'FLR-RB-003', price: 5000 },
  { code: 'FLR-RB-004', price: 6500 },
  { code: 'FLR-RB-005', price: 3800 },
  { code: 'FLR-RB-006', price: 4800 },
  { code: 'FLR-RB-007', price: 5500 },
  { code: 'FLR-RB-008', price: 7200 },
];
  ...
  return (
    <main className="min-h-screen bg-gray-50 py-10">
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900">Rose Bunches</h1>
          <p className="mt-3 text-gray-600">Elegant rose bunches for every occasion.</p>
        </div>
