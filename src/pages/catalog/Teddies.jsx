...
const items = [
  { code: 'FLR-TD-001', price: 3800 },
  { code: 'FLR-TD-002', price: 4500 },
  { code: 'FLR-TD-003', price: 5200 },
  { code: 'FLR-TD-004', price: 6000 },
  { code: 'FLR-TD-005', price: 4200 },
  { code: 'FLR-TD-006', price: 4800 },
  { code: 'FLR-TD-007', price: 5500 },
  { code: 'FLR-TD-008', price: 6500 },
];
  ...
  return (
    <main className="min-h-screen bg-gray-50 py-10">
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900">Teddies</h1>
          <p className="mt-3 text-gray-600">Adorable teddy bear gift sets for special moments.</p>
        </div>
