...
const items = [
  { code: 'FLR-MB-001', price: 8500 },
  { code: 'FLR-MB-002', price: 10000 },
  { code: 'FLR-MB-003', price: 12000 },
  { code: 'FLR-MB-004', price: 15000 },
  { code: 'FLR-MB-005', price: 9000 },
  { code: 'FLR-MB-006', price: 11000 },
  { code: 'FLR-MB-007', price: 13000 },
  { code: 'FLR-MB-008', price: 16000 },
];
  ...
  return (
    <main className="min-h-screen bg-gray-50 py-10">
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900">Money Bunches</h1>
          <p className="mt-3 text-gray-600">Stylish money bunches for special occasions.</p>
        </div>
