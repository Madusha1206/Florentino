...
const items = [
  { code: 'FLR-BR-001', price: 2500 },
  { code: 'FLR-BR-002', price: 3000 },
  { code: 'FLR-BR-003', price: 3500 },
  { code: 'FLR-BR-004', price: 4000 },
  { code: 'FLR-BR-005', price: 2800 },
  { code: 'FLR-BR-006', price: 3200 },
  { code: 'FLR-BR-007', price: 3800 },
  { code: 'FLR-BR-008', price: 4500 },
];
  ...
  return (
    <main className="min-h-screen bg-gray-50 py-10">
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900">Brownies</h1>
          <p className="mt-3 text-gray-600">Delicious brownies for gifts and celebrations.</p>
        </div>
