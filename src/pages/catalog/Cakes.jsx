...
const items = [
  { code: 'FLR-CK-001', price: 3200 },
  { code: 'FLR-CK-002', price: 3800 },
  { code: 'FLR-CK-003', price: 4500 },
  { code: 'FLR-CK-004', price: 5200 },
  { code: 'FLR-CK-005', price: 3500 },
  { code: 'FLR-CK-006', price: 4200 },
  { code: 'FLR-CK-007', price: 4800 },
  { code: 'FLR-CK-008', price: 5500 },
];
  ...
  return (
    <main className="min-h-screen bg-gray-50 py-10">
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900">Cakes</h1>
          <p className="mt-3 text-gray-600">Freshly baked cakes for every celebration.</p>
        </div>
